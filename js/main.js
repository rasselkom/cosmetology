...
/* harmony import */ var _components_form__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_components_form__WEBPACK_IMPORTED_MODULE_5__);
...
if (trigger && social) {
  trigger.addEventListener('click', () => {
    social.classList.toggle('social_opened');
  });
}
...
window.addEventListener("DOMContentLoaded", function () {
  [].forEach.call(document.querySelectorAll('#telFF'), function (input) {
    var keyCode;
    function mask(event) {
